    ...
    <form id="settings-form" style="padding-bottom: 1rem; width: 600px;">
        <div id="main-settings-section" style="padding-bottom: 1rem;">
            ...
            <div class="settings-table settings-table-main">
                ...
                <input id="server-url" type="text" style="width: 400px;" placeholder="https://www.mydomain.com" value="<?php p($_['server_url']) ?>"/>
                <div class="settings-table-info"><em>The URL of your bridgit server.</em></div>

                <label for="api-key">API Key:</label>
                <input id="api-key" type="text" style="width: 400px;" placeholder="some-key" value="<?php p($_['api_key']) ?>"/>
                <div class="settings-table-info"><em>The API key used to communicate directly with the bridgit server (must be the same as used during the deployment of bridgit).</em></div>
            </div>
        </div>
    </form>
